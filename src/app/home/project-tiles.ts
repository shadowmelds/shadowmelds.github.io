...
export class ProjectTilesComponent {
    ...
    getProjects(x): void {
        ...
        if (x) {
            // 双行
            this.projects = [
                {icon: '/src/assets/img/project_shadowmeld_site.png', name: 'ShadowmeldHome', content: '本网站的开源地址',
                    url: 'https://github.com/shadowmelds/shadowmelds.github.io'}
            ];
            this.projectsTwo = [
                {icon: '/src/assets/img/project_shadowmeld_site.png', name: 'ShadowmeldWebsite', content: '本网站的旧版本开源地址',
