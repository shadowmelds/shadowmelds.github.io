...
var ChipSkillButtonComponent = /** @class */ (function () {
    ...
    ChipSkillButtonComponent.prototype.getSkills = function () {
        this.skills = [
            ...
            { id: 4, title: 'TypeScript', icon: '../assets/icons/typescript.svg', primary: '#007ACC', primaryDark: '#004ba0',
                titleColor: this.styleMethod02('#007ACC'), rating: 19 },
            { id: 5, title: 'CSS3', icon: '../assets/icons/css-3-logo.svg', primary: '#1B84C2', primaryDark: '#004ba0',
                titleColor: this.styleMethod02('#1B84C2'), rating: 26 },
            { id: 6, title: 'HTML5', icon: '../assets/icons/html5.svg', primary: '#EA6228', primaryDark: '#c43e00',
                titleColor: this.styleMethod02('#EA6228'), rating: 24 },
            { id: 7, title: 'Overwatch', icon: '../assets/icons/overwatch.svg', primary: '#FA9C1E', primaryDark: '#c67c17',
                titleColor: this.styleMethod02('#FA9C1E'), rating: 48 },
            { id: 8, title: 'Blender', icon: '../assets/icons/blender.svg', primary: '#E87C0D', primaryDark: '#b4600a',
